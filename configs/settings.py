...
# n=1: 3-свечной паттерн (более чувствительный).
# n=2: 5-свечной паттерн (менее чувствительный, более надежные свинги).
SWING_POINT_N = 1 # ИЗМЕНЕНО С 2 НА 1 для обнаружения 3-свечных фракталов
