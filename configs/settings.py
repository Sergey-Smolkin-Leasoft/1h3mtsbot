...
# Время сессий указано в UTC+3.
# Значения переменных _UTC - это эквивалентное время в UTC для корректной фильтрации данных.
ASIAN_SESSION_START_HOUR_UTC3 = 1
ASIAN_SESSION_START_MINUTE_UTC3 = 0
ASIAN_SESSION_END_HOUR_UTC3 = 9
ASIAN_SESSION_END_MINUTE_UTC3 = 0

NY_SESSION_START_HOUR_UTC3 = 15
NY_SESSION_START_MINUTE_UTC3 = 0
NY_SESSION_END_HOUR_UTC3 = 22
NY_SESSION_END_MINUTE_UTC3 = 0

# Эквивалентное время в UTC для использования в логике анализа
ASIAN_SESSION_START_HOUR_UTC = 22 # Соответствует 01:00 UTC+3 предыдущего дня
ASIAN_SESSION_START_MINUTE_UTC = 0
ASIAN_SESSION_END_HOUR_UTC = 6 # Соответствует 09:00 UTC+3
ASIAN_SESSION_END_MINUTE_UTC = 0

NY_SESSION_START_HOUR_UTC = 12 # Соответствует 15:00 UTC+3
NY_SESSION_START_MINUTE_UTC = 0
NY_SESSION_END_HOUR_UTC = 19 # Соответствует 22:00 UTC+3
NY_SESSION_END_MINUTE_UTC = 0


NY_SESSIONS_TO_CHECK_PREVIOUS_DAYS = 1 # Проверка предыдущего дня для NY сессии
